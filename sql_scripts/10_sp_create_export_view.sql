-- =====================================================
-- Stored Procedure to Create Export View
-- =====================================================
CREATE OR REPLACE PROCEDURE create_export_view()
LANGUAGE plpgsql
AS $$
BEGIN
    -- Create or replace the export view
    ...
    RAISE NOTICE 'Export view created successfully';
END;
$$;

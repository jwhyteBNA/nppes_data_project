    CREATE TABLE IF NOT EXISTS nppes_providers (
        ...
        healthcare_provider_primary_taxonomy_switch_1 VARCHAR(10),
        healthcare_provider_taxonomy_code_2 VARCHAR(20),
        healthcare_provider_primary_taxonomy_switch_2 VARCHAR(10),
        healthcare_provider_taxonomy_code_3 VARCHAR(20),
        healthcare_provider_primary_taxonomy_switch_3 VARCHAR(10),
        healthcare_provider_taxonomy_code_4 VARCHAR(20),
        healthcare_provider_primary_taxonomy_switch_4 VARCHAR(10),
        healthcare_provider_taxonomy_code_5 VARCHAR(20),
        healthcare_provider_primary_taxonomy_switch_5 VARCHAR(10),
        healthcare_provider_taxonomy_code_6 VARCHAR(20),
        healthcare_provider_primary_taxonomy_switch_6 VARCHAR(10),
        healthcare_provider_taxonomy_code_7 VARCHAR(20),
        healthcare_provider_primary_taxonomy_switch_7 VARCHAR(10),
        healthcare_provider_taxonomy_code_8 VARCHAR(20),
        healthcare_provider_primary_taxonomy_switch_8 VARCHAR(10),
        healthcare_provider_taxonomy_code_9 VARCHAR(20),
        healthcare_provider_primary_taxonomy_switch_9 VARCHAR(10),
        healthcare_provider_taxonomy_code_10 VARCHAR(20),
        healthcare_provider_primary_taxonomy_switch_10 VARCHAR(10),
        healthcare_provider_taxonomy_code_11 VARCHAR(20),
        healthcare_provider_primary_taxonomy_switch_11 VARCHAR(10),
        healthcare_provider_taxonomy_code_12 VARCHAR(20),
        healthcare_provider_primary_taxonomy_switch_12 VARCHAR(10),
        healthcare_provider_taxonomy_code_13 VARCHAR(20),
        healthcare_provider_primary_taxonomy_switch_13 VARCHAR(10),
        healthcare_provider_taxonomy_code_14 VARCHAR(20),
        healthcare_provider_primary_taxonomy_switch_14 VARCHAR(10),
        healthcare_provider_taxonomy_code_15 VARCHAR(20),
        healthcare_provider_primary_taxonomy_switch_15 VARCHAR(10),
